...
static void MX_TIM1_Init(void)
{
  ...
  //htim1.Init.Period = 2396; //
  //------------------------------------------- End 10000 Hz

  //------------------------------------------- Begin 11000 Hz
  //htim1.Init.Prescaler = 2; // 11000 Hz
  //htim1.Init.Period = 2180; //
  //------------------------------------------- End 11000 Hz

  //------------------------------------------- Begin 12000 Hz
  //htim1.Init.Prescaler = 2; // 12000 Hz
  //htim1.Init.Period = 1998; //
  //------------------------------------------- End 12000 Hz

  //------------------------------------------- Begin 13000 Hz
  //htim1.Init.Prescaler = 2; // 13000 Hz
  //htim1.Init.Period = 1845; //
  //------------------------------------------- End 13000 Hz

  //------------------------------------------- Begin 14000 Hz
  //htim1.Init.Prescaler = 2; // 14000 Hz
  //htim1.Init.Period = 1710; //
  //------------------------------------------- End 14000 Hz

  //------------------------------------------- Begin 15000 Hz
  //htim1.Init.Prescaler = 2; // 15000 Hz
  //htim1.Init.Period = 1599; //
  //------------------------------------------- End 15000 Hz

  //------------------------------------------- Begin 15920 Hz
  htim1.Init.Prescaler = 2; // 15920 Hz
  htim1.Init.Period = 1506; //
  //------------------------------------------- End 15920 Hz
